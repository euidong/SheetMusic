...
if __name__ == "__main__":
    ...
    cv2.imwrite('cutting1.png', measures[0])
    cv2.imwrite('cutting2.png', measures[1])
    cv2.imwrite('cutting3.png', measures[2])
    cv2.imwrite('cutting4.png', measures[3])
    cv2.imwrite('cutting5.png', measures[4])
    cv2.imwrite('cutting6.png', measures[5])
    cv2.imwrite('cutting7.png', measures[6])
    cv2.imwrite('cutting8.png', measures[7])
    cv2.imwrite('cutting9.png', measures[8])
    cv2.waitKey(0)
